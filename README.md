...
1. **Password Otomatis**: jarsWAF tidak menggunakan password default statis (seperti `admin` / `change-me`). Password unik acak 16-karakter akan dibuat secara otomatis saat pertama kali di-install.
