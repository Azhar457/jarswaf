...
<header class="h-16 bg-slate-950 border-b border-slate-800 flex items-center justify-between px-6 sticky top-0 z-10">
  <div class="flex items-center gap-4">
    <div class="flex items-center gap-2 px-3 py-1.5 bg-slate-900 rounded-full border border-slate-800">
      <div class={`w-2 h-2 rounded-full ${
        systemStatus === 'online' ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]' :
        systemStatus === 'degraded' ? 'bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)]' :
